...
const sendVerificationEmail = (email, userFirstName, token)=>{
    const options = {
        to: email,
        subject: "🚀 Welcome to JuMia! Let&apos;s Verify Your Account!",
        ...
        <p style="margin-bottom: 16px;">
          Thanks for signing up for <strong>Jumia</strong> — we're thrilled to have you on board!
        </p>
        ...
        <p style="font-weight: bold;">The Jumia Team</p>
      </div>
        `
    }
